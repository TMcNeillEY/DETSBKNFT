...
// // import "../contracts/IWhitelist.sol";
...
// contract DetSbkDevs is ERC721Enumerable, ReentrancyGuard, Ownable {
...
//         return pluck(tokenId, "MIND", certifications);
//     }
    
//     function getVibe(uint256 tokenId) public view returns (string memory) {
//         return pluck(tokenId, "VIBE", frontend);
//     }
...
//     //       require(tokenId < maxTokenIds, "Exceeded maximum DET SBK NFT supply");
