...
contract Dev is ERC721Enumerable, ReentrancyGuard, Ownable {
    ...
    string[] private certifications = [
        ...
        "Microsoft certified solutions associate/expert",
    ...
    function getDegree(uint256 tokenId) public view returns (string memory) {
        return pluck(tokenId, "DEGREE", degree);
    }
    ...
    function getCertifications(uint256 tokenId) public view returns (string memory) {
        return pluck(tokenId, "CERTIFICATIONS", certifications);
    }
    
    function getFrontend(uint256 tokenId) public view returns (string memory) {
        return pluck(tokenId, "FRONTEND", frontend);
    }
    ...
    function tokenURI(uint256 tokenId) override public view returns (string memory) {
        ...
        parts[15] = getCertifications(tokenId);

        parts[16] = '</text><text x="10" y="160" class="base">';

        parts[17] = getFrontend(tokenId);
    ...
    constructor() ERC721("DET SBK Devs", "DETSBK") Ownable() {}
}
